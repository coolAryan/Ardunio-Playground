...
void IR1()
{
  ...
  //0000000      Ending Box Case
   if (digitalRead(LS1) == 0 && digitalRead(LS2) == 0 && digitalRead(RS1) == 0 && digitalRead(RS2) == 0  &&  digitalRead(MS) == 0  &&  digitalRead(FLS) == 1&&  digitalRead(FS) == 0 )
  {
    analogWrite(ENL, 55);     // LEFT MOTOR SPEED (0-254)
    analogWrite(ENR, 55);     // RIGHT MOTOR SPEED (0-254)
    stop();
...
void IR2()
{
  ...
  //0000000      Ending Box Case
   if (digitalRead(LS1) == 0 && digitalRead(LS2) == 0 && digitalRead(RS1) == 0 && digitalRead(RS2) == 0  &&  digitalRead(FS) == 0  &&  digitalRead(FLS) == 1 &&  digitalRead(MS) == 0 )
  {
    analogWrite(ENL, 55);     // LEFT MOTOR SPEED (0-254)
    analogWrite(ENR, 55);     // RIGHT MOTOR SPEED (0-254)
    stop();
