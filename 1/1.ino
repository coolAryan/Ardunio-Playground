...
//10000
  ...
  //00010
  else if (digitalRead(LS1) == 0 && digitalRead(LS2) == 0 &&digitalRead(MS)==0 digitalRead(RS1) == 1 && digitalRead(RS2) == 0 )
  {
    analogWrite(ENL, 60);     // LEFT MOTOR SPEED (0-254)
    analogWrite(ENR, 60);     // RIGHT MOTOR SPEED (0-254)
    TR();
...
//00111 1
  ...
  //01000
  else if (digitalRead(LS1) == 0 && digitalRead(LS2) == 1 &&digitalRead(MS)==0 digitalRead(RS1) == 0 && digitalRead(RS2) == 0 )
  {
    analogWrite(ENL, 60);     // LEFT MOTOR SPEED (0-254)
    analogWrite(ENR, 60);     // RIGHT MOTOR SPEED (0-254)
    TL();
...
//01111 1
  else if (digitalRead(LS1) == 0 && digitalRead(LS2) == 1 &&digitalRead(MS)==1 digitalRead(RS1) == 1 && digitalRead(RS2) == 1 && digitalRead(FS)==)
  {
    analogWrite(ENL, 60);     // LEFT MOTOR SPEED (0-254)
    analogWrite(ENR, 60);     // RIGHT MOTOR SPEED (0-254)
   fwd();
  ...
  //11000
  else if (digitalRead(LS1) == 1 && digitalRead(LS2) == 1 &&digitalRead(MS)==0 digitalRead(RS1) == 0 && digitalRead(RS2) == 0 )
  {
    analogWrite(ENL, 60);     // LEFT MOTOR SPEED (0-254)
    analogWrite(ENR, 60);     // RIGHT MOTOR SPEED (0-254)
    TL();
 ...
 //00011
 else if (digitalRead(LS1) == 0 && digitalRead(LS2) == 0 &&digitalRead(MS)==0 digitalRead(RS1) == 1 && digitalRead(RS2) == 1   )
  {
    analogWrite(ENL, 60);     // LEFT MOTOR SPEED (0-254)
    analogWrite(ENR, 60);     // RIGHT MOTOR SPEED (0-254)
    TR();
  ...
  //11110 1 0R 0
  else if (digitalRead(LS1) == 1 && digitalRead(LS2) == 1 && digitalRead(MS) == 1&&  digitalRead(RS1) == 1 && digitalRead(RS2) == 0 && (digitalRead(FS) == 1 ||digitalRead(FS)==0))
  {
    analogWrite(ENL, 60);     // LEFT MOTOR SPEED (0-254)
    analogWrite(ENR, 60);     // RIGHT MOTOR SPEED (0-254)
    BL();
  ...
  //11111
  else if (digitalRead(LS1) == 1 && digitalRead(LS2) == 1&& digitalRead(MS) == 1 && digitalRead(RS1) == 1 && digitalRead(RS2) == 1 && (digitalRead(FS) == 0 ||digitalRead(FS)==1))
  {
    analogWrite(ENL, 60);    // LEFT MOTOR SPEED (0-254)
    analogWrite(ENR, 60);     // RIGHT MOTOR SPEED (0-254)
    BL();
