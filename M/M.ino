...
void IR1()
{
  ...
  //0000011      Ending Box Case
  else if (digitalRead(LS1) == 0 && digitalRead(LS2) == 0 && digitalRead(RS1) == 0 && digitalRead(RS2) == 0  &&  digitalRead(MS) == 0  &&  digitalRead(FLS) == 1 &&  digitalRead(FS) == 1 )
  {
    analogWrite(ENL, 60);     // LEFT MOTOR SPEED (0-254)
    analogWrite(ENR, 60);     // RIGHT MOTOR SPEED (0-254)
    stop();
...
void IR2()
{
  ...
  //000000
  else if (digitalRead(LS1) == 0 && digitalRead(LS2) == 0 && digitalRead(RS1) == 0 && digitalRead(RS2) == 0 &&  digitalRead(FS) == 0 && digitalRead(MS) == 0 )
  {
    analogWrite(ENL, 60);     // LEFT MOTOR SPEED (0-254)
    analogWrite(ENR, 60);     // RIGHT MOTOR SPEED (0-254)
    if (b[j] == 'S')
  ...
  //0000110      Ending Box Case
  else if (digitalRead(LS1) == 0 && digitalRead(LS2) == 0 && digitalRead(RS1) == 0 && digitalRead(RS2) == 0  &&  digitalRead(FS) == 1  &&  digitalRead(FLS) == 1 &&  digitalRead(MS) == 0 )
  {
    analogWrite(ENL, 60);     // LEFT MOTOR SPEED (0-254)
    analogWrite(ENR, 60);     // RIGHT MOTOR SPEED (0-254)
    stop();
